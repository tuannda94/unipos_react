            ...
            <div className="header-profile-detail">
                <div>
                    ...
                    <div className="default-label">
                        <label title={userProfile.member && userProfile.member.display_name}>{userProfile.member && userProfile.member.display_name}</label>
                    </div>
                </div>
                <div>
                    <div className="default-title">
                    ...
                    <div className="default-label">
                        <label title={userProfile.member && userProfile.member.email_address}>{userProfile.member && userProfile.member.email_address}</label>
                    </div>
                </div>
                <div>
                    <div className="default-title">
                    ...
                    <div className="default-label">
                        <label title={userProfile.groups[0] && userProfile.groups[0].name}>{userProfile.groups[0] && userProfile.groups[0].name}</label>
                    </div>
                </div>
            </div>
        </div>
