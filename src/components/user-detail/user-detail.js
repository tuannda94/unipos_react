            ...
            <div className="header-profile-detail">
                <div>
                    ...
                    <div className="default-label">
                        <label title={userProfile.member.display_name ? userProfile.member.display_name : ''}>{userProfile.member.display_name ? userProfile.member.display_name : ''}</label>
                    </div>
                </div>
                <div>
                    <div className="default-title">
                    ...
                    <div className="default-label">
                        <label title={userProfile.member.email_address ? userProfile.member.email_address : ''}>{userProfile.member.email_address ? userProfile.member.email_address : ''}</label>
                    </div>
                </div>
                <div>
                    <div className="default-title">
                    ...
                    <div className="default-label">
                        <label title={userProfile.groups.length && userProfile.groups[0].name}>{userProfile.groups.length && userProfile.groups[0].name}</label>
                    </div>
                </div>
            </div>
        </div>
