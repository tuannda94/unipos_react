...
var UserDetail = function UserDetail(_ref) {
    var user_avatar = _ref.user_avatar,
        userName = _ref.userName,
        email = _ref.email,
        groupName = _ref.groupName,
        totalReceivedPoint = _ref.totalReceivedPoint,
        totalSentPoint = _ref.totalSentPoint,
        totalClappedPoint = _ref.totalClappedPoint;
    return _react2.default.createElement('div', { className: 'unipos-wrapper' }, _react2.default.createElement('div', { className: 'headers' }, _react2.default.createElement('div', { className: 'header-avatar' }, _react2.default.createElement('img', { src: user_avatar, className: 'involvingMember_picture' })), _react2.default.createElement('div', { className: 'header-profile-detail' }, _react2.default.createElement('div', null, _react2.default.createElement('div', { className: 'default-title' }, _react2.default.createElement('label', null, 'Name')), _react2.default.createElement('div', { className: 'default-label' }, _react2.default.createElement('label', null, userName))), _react2.default.createElement('div', null, _react2.default.createElement('div', { className: 'default-title' }, _react2.default.createElement('label', null, 'E-mail')), _react2.default.createElement('div', { className: 'default-label' }, _react2.default.createElement('label', null, email))), _react2.default.createElement('div', null, _react2.default.createElement('div', { className: 'default-title' }, _react2.default.createElement('label', null, 'Groups')), _react2.default.createElement('div', { className: 'default-label' }, _react2.default.createElement('label', null, groupName))))), _react2.default.createElement('table', { className: 'box' }, _react2.default.createElement('tbody', null, _react2.default.createElement('tr', { className: 'partial' }, _react2.default.createElement('td', { className: 'tbox-left' }, 'Point Received'), _react2.default.createElement('td', { className: 'tbox-right' }, totalReceivedPoint)), _react2.default.createElement('tr', { className: 'partial' }, _react2.default.createElement('td', { className: 'tbox-left' }, 'Point Sent'), _react2.default.createElement('td', { className: 'tbox-right' }, totalSentPoint)), _react2.default.createElement('tr', { className: 'partial' }, _react2.default.createElement('td', { className: 'tbox-left' }, 'Post Clapped'), _react2.default.createElement('td', { className: 'tbox-right' }, totalClappedPoint)))));
};
...
var _userDetail = __webpack_require__(13);

var _userDetail2 = _interopRequireDefault(_userDetail);

var _registerServiceWorker = __webpack_require__(14);
...
function run() {
    _reactDom2.default.render(_react2.default.createElement(_userDetail2.default, null), document.getElementById('user_detail_wrapper'));
    (0, _registerServiceWorker2.default)();
}

var user_detail_wrapper = document.createElement('div');
...
chrome.runtime.onMessage.addListener(function (params) {
    if (params.message === 'onPageLoad') {
        if (window.location.href.indexOf(_commons2.default.BASE_URL) != -1) {
            var urlParams = window.location.href.replace(_commons2.default.BASE_URL, '').split("?")[1];
            if (urlParams !== null && urlParams !== undefined) {
                var currentUserId = urlParams.split("=")[1];
                var route = (0, _helpers.dispatch)();
                if (Object.keys(route).length) {
                    ...
                    var controller = route.controller.substring(route.controller.lastIndexOf('/') + 1);
...
if(false) {
	module.hot.accept("!!../../../node_modules/css-loader/index.js!./user-detail.css", function() {
		var newContent = require("!!../../../node_modules/css-loader/index.js!./user-detail.css");
...
// module
exports.push([module.i, ".unipos-wrapper {\n  position: fixed;\n  overflow-y: scroll;\n  overflow-x: hidden;\n  right: 2%;\n  top: 15%;\n  width: 15%;\n  overflow: hidden;\n  border: 1px solid #dde2e2;\n  border-radius: 20px;\n  float: right;\n  box-sizing: border-box;\n}\n\n.default-label {\n  line-height: 130%;\n  width: 100%;\n  display: inline-table;\n}\n\n.default-title {\n  line-height: 130%;\n  width: 50%;\n  display: inline-table;\n  font-size: 110%;\n  font-weight: bold;\n}\n\n.partial {\n  line-height: 150%;\n  font-size: 17px;\n}\n\n.box {\n  width: 100%;\n  margin-top: 10%;\n  margin-bottom: 10%;\n  background: #fff;\n}\n\n.header-avatar {\n  margin-top: 20px;\n}\n\n.header-profile-detail {\n  margin-top: 20px;\n}\n\n.tbox-left {\n  text-align: center;\n  width: 50%;\n}\n\n.tbox-right {\n  text-align: center;\n  width: 50%;\n}\n\n.headers {\n  width: 100%;\n  text-align: center;\n  background-image: linear-gradient(\n    rgba(255, 255, 255, 0),\n    rgba(255, 255, 255, 0)\n  ),\n  linear-gradient(to right, #8bdde1, #b5f5c1);\n  padding-top: 10px;\n  padding-bottom: 10px;\n  line-height: 135%;\n}\n\ntable {\n  overflow: hidden;\n}\n\ntd {\n  text-align: center;\n}\n\n.unipos-icon {\n  width: 20px;\n  height: 20px;\n  fill: inherit;\n  margin-left: 5px;\n  margin-right: 5px;\n}\n", ""]);
...
function makeRequest(data, token) {
    var unipos = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    var method = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'POST';

    return new Promise(function (resolve, reject) {
        axios({
            "url": _commons2.default.API_URL,
            "method": method,
            "headers": {
...
function dispatch() {
    var currentRoute = window.location.href.replace(_commons2.default.BASE_URL, '').split("?")[0];
    var routeMatching = {};
    for (var key in routeMap) {
        if (currentRoute == key) {
            var route = routeMap[key].split("@");
            routeMatching = {
                'controller': route[0],
                'action': route[1]
            };
